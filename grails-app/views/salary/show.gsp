...
<html>
    ...
    <body>
        ...
        <div id="show-salary" class="content scaffold-show" role="main">
            ...
            <f:display bean="salary" />
            <g:form resource="${this.salary}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.salary}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
